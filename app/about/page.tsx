    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-blue-50 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          ContractAI is built to help founders, operators, and freelancers understand legal
          documents faster without losing the important details.
        </p>
        <p className="text-slate-600 leading-relaxed">
          The platform focuses on practical outcomes: clear summaries, actionable risks,
